            ...
            filesMatching("server.properties") {
                ...
                filter { line ->
                    ...
                    if (line.startsWith("motd=")) {
                        "motd=[$loaderName] Development Server"
                    } else {
                        line
                    }
                }
...
tasks {
    ...
    shadowJar {
        // shadowJar はサフィックスなしで出力します (stpm-paper-x.x.x.jar)。
